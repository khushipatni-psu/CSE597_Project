...
def evaluate_moment_summarization(gt_data, pred_data, gpu_device: int):
    ...
    if gpu_device != -1 and args.frame_dir != "None":
        import clip
        model, preprocess = clip.load("ViT-B/32", device=f"cuda:{gpu_device}", cache_dir = "/scratch/kvp5738/cache")
    ...
    for cat in PROMPT_CATEGORIES:
        ...
        # os.environ["HF_HOME"] = "/scratch/kvp5738/cache"
        from bert_score1 import score
