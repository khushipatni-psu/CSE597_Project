...
class MomentModel(nn.Module):
    ...
    def __init__(self, n_frames=-1, asr_dim=-1, args=None):
        ...
        model_state_dict = torch.load("/scratch/kvp5738/HiREST/hfdownloads/models--j-min--HiREST-baseline/snapshots/54e2f8da7a4384fec8a137011399f5e104069032/clip4caption_vit-b-32_model.bin", map_location='cpu')
        ...
        self.clip_model, self.clip_preprocess = build_eva_model_and_transforms("EVA_CLIP_g_14", pretrained="/scratch/kvp5738/HiREST/hfdownloads/models--BAAI--EVA/snapshots/2e248c61b528fc69dd82b0c99ec17fa2ab03f622/eva_clip_psz14.pt")
